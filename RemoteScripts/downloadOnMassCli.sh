...
ssh -X -A mass-cli1 'ls -lhrt /group_workspaces/jasmin2/ukesm/BGC_data/u-ad980; ln -s  /group_workspaces/jasmin2/ukesm/BGC_data/u-ad980/*1y*grid_[UVWT]*.nc /group_workspaces/jasmin2/ukesm/BGC_data/u-ad980/1y/.'
