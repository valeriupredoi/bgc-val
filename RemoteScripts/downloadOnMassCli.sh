...
ssh -X -A mass-cli1 "python /home/users/ldemora/workspace/ukesm-validation/bgcvaltools/downloadFromMass.py $jobid;python /home/users/ldemora/workspace/ukesm-validation/bgcvaltools/downloadFromMass.py $jobid mld"
